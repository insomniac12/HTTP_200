...
class StudentTest(TestCase):
    ...
    def setUp(self):
        ...
        StudentDetail.objects.create(semester=5,branch='IT', univ_roll_no=1309113001, contact_no=9813728934,
    ...
    def test_create_student(self):
        ...
        self.assertEqual(student_details.semester, 5)
...
class form_test(TestCase):
    ...
    def test_student_form(self):
        form_data = {'semester': 5, 'branch': "IT", 'univ_roll_no': 1309113001, 'contact_no': 9813728934,
                     'father_name': '', 'mother_name': '', 'address': '', 'course': "BTECH", 'display_to_others': ''}
...
class UserProfileTest(TestCase):
    ...
    def setUp(self):
        ...
        self.student_detail=StudentDetail.objects.create(semester=3,branch='IT',univ_roll_no=1309113001,contact_no=9813728934 ,father_name='',mother_name='',address='',course='B.Tech',display_to_others='',user=self.user)
